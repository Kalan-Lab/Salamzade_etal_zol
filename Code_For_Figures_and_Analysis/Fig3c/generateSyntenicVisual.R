...
input.file <- args[1] # Track.txt - the result from the script generateSyntenicVisual.py in the zol Github repo
...
ggplot(input.data, aes(xmin=Start, xmax = End, y = "", forward = Direction, label=SC)) +
  ...
  scale_fill_gradient(low='#d498e3', high='#5a3263', breaks =c(0.0, 0.25, 0.5, 0.75, 1.0),
