...
colors <- c('#bc76c2', '#DC555E', '#a18560', '#FDBF72', '#FEEDA2', '#F1F9A9', '#BEE5A0', '#78C9A6', '#4796C0', '#6152A4', '#fa9200')
names(colors) <- c('EF2167', 'epaX', 'EF2176', 'epaO', 'epaN', 'epaI', 'epaD', 'epaC', 'epaB', 'epaA', 'epaR')
