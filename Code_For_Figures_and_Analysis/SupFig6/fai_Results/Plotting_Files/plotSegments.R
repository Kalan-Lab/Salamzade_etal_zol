...
que.info.file <- "/workspace/local/rauf/zol/update_manuscript_apps/Enterococcus_Epa/Comparisons/CoreSimul/fai_Results/Plotting_Files/Name_Mapping.txt"
seg.data.file <- "/workspace/local/rauf/zol/update_manuscript_apps/Enterococcus_Epa/Comparisons/CoreSimul/fai_Results/Plotting_Files/Bar_Plot_Input.txt"
pdf_file <- "/workspace/local/rauf/zol/update_manuscript_apps/Enterococcus_Epa/Comparisons/CoreSimul/fai_Results/Final_Results/Homologous_Gene_Cluster_Segments.pdf"
pdf_file2 <- "/workspace/local/rauf/zol/update_manuscript_apps/Enterococcus_Epa/Comparisons/CoreSimul/fai_Results/Final_Results/Name_Mapping_of_Queries_to_Original_LocusTags.pdf"
height <- as.numeric(5)
width <- as.numeric(15)
